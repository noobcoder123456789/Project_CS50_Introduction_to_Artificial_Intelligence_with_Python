...
def evaluate(labels, predictions):
    ...
    """
    truePositiveRate = trueNegativeRate = positive = negative = 0
    for i in range(len(labels)):
        negative += labels[i] == 0
        positive += labels[i] == 1                
        trueNegativeRate += labels[i] == predictions[i] and labels[i] == 0
        truePositiveRate += labels[i] == predictions[i] and labels[i] == 1
    
    return (truePositiveRate / positive, trueNegativeRate / negative)
    raise NotImplementedError
